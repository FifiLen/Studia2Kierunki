...
export const psychoterapia: Course = {
  ...
  modules: [
    {
      title:
        "Pierwszy poziom kształcenia <br /> <span classname='text-zinc-600 tracking-tight text-sm'>(4 semestry, 600 godz. , 150 godz. /semestr)</span>",
      topics: [
        {
          title: "Semestr 1",
          subtopics: [
  ...
  practices: `<ul className="list-disc list-inside space-y-2">
    <li>150 godz. zegarowych w&nbsp;oddziale psychiatrii całodobowej&nbsp;lub w&nbsp;izbie przyjęć przy oddziale psychiatrycznym całodobowym lub&nbsp;w&nbsp;oddziale psychiatrycznym w&nbsp;oddziale dziennym; w&nbsp;tym 50 godz. zegarowych superwizja dzieci, młodzieży i&nbsp;dorosłych</li>
    <li>250 godz. zegarowych pracy klinicznej pod opieką merytoryczną psychiatry lub psychoterapeuty lub psychologa klinicznego; w&nbsp;tym 50 godz. zegarowych superwizja dzieci, młodzieży i&nbsp;dorosłych</li>
  </ul>`,
  evaluation:
  ...
  invite:
    "<div class=''> <p class='text-gray-100'>Rozpocznij swoją zawodową przygodę jako <strong class='font-semibold'>psychoterapeuta</strong>.<br /> Inwestuj w swoją przyszłość i realizuj swoje nowe perspektywy zawodowe.</p></div>",
};
