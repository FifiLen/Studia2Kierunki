...
export const trenerUmiejetnosciSpolecznych: Course = {
      ...
      topics: [
        ...
        },
        {
          ...
          subtopics: [
            ...
            {
              title: "Metody nauczania i kształcenia umiejętności społecznych",
            },
            { title: "Praca z grupą" },
          ],
        },
  ...
  <span className="block mb-2">-Konsultanci w firmach szkoleniowych</span>
  <span className="block mb-2">-Specjaliści ds. rozwoju osobistego i zawodowego</span>
  <span className="block mb-2">-Pracownicy w organizacjach pozarządowych zajmujących się edukacją i wsparciem społecznym</span>
  <span className="block mb-2">-Coachowie i mentorzy</span>
