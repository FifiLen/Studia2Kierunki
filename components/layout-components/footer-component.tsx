...
import { FaFacebook, FaYoutube, FaChevronDown, FaChevronUp } from "react-icons/fa"
...
const courseCategories = [
  {
    ...
    courses: courses.filter(course =>
        ["psychoterapia", "psychologia-uzaleznien-z-terapia-uzaleznien", "psychologia-uzaleznien-uzaleznienia-behawioralne", "diagnoza-i-strategie-terapeutyczne-w-leczeniu-hiperseksualnosci", "cyberpsychologia", "seksuologia-praktyczna"].includes(course.id)
    )
  },
  {
    ...
    courses: courses.filter(course =>
        ["logopedia", "pedagogika-korekcyjna", "pedagogika-specjalna-autyzm", "oligofrenopedagogika", "surdopedagogika", "tyflopedagogika", "integracja-sensoryczna-z-terapia-reki", "wczesne-wspomaganie-rozwoju-dziecka", "edukacja-integracyjna-i-wlaczajaca", "przygotowanie-pedagogiczne", "trener-umiejetnosci-spolecznych", "pedagogika-marii-montessori"].includes(course.id)
    )
  },
  {
    ...
    courses: courses.filter(course =>
        ["zarzadzanie-oswiata", "etyka", "wychowanie-do-zycia-w-rodzinie", "informatyka", "dydaktyka-jezyka-obcego-niemiecki", "przyroda-w-szkole-podstawowej", "edukacja-dla-bezpieczenstwa", "wychowanie-fizyczne-w-szkole", "chemia-w-szkole", "jezyk-angielski-w-wychowaniu-przedszkolnym-i-edukacji-wczesnoszkolnej"].includes(course.id)
    )
  }
]
