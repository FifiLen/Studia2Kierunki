...
import { TbTargetArrow, TbAlignBoxLeftTop, TbChevronRight } from 'react-icons/tb'
...
export function AboutCourse({ course }: AboutCourseProps) {
        ...
        if (domNode.name === 'li') {
          ...
          return (
              <li className="flex items-start gap-2.5 group">
                ...
                <span className="text-purple-600/80 leading-relaxed">{parse(children.map((c: any) => c.data || '').join(' '))}</span>
              </li>
          )
        }
      }
  ...
  return (
      <section id="opis" className="w-full bg-gradient-to-b from-gray-50 to-gray-100 py-20 md:py-28">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          >
            ...
            <p className="tracking-tight text-gray-500 mt-4">
              Zapoznaj się ze szczegółowymi informacjami na temat kierunku i dowiedz się, dla kogo jest przeznaczony.
            </p>
          </motion.div>
