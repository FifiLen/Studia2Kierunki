...
import { Type, Palette, Contrast, Underline, Space, MousePointerClick, Accessibility} from 'lucide-react'
...
export function AccessibilityPanel() {
    ...
    const applySettings = () => {
        ...
        document.documentElement.style.setProperty('--font-family', settings.fontFamily === 'default' ? 'inherit' : settings.fontFamily)
        ...
        document.documentElement.classList.toggle('underline-links', settings.underlineLinks)
        document.documentElement.classList.toggle('highlight-links', settings.highlightLinks)
        document.documentElement.classList.toggle('large-cursor', settings.cursorSize === 'large')
    }
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50">
            <Button onClick={togglePanel} variant="outline" size="icon" className="bg-blue-500">
                    ...
                    <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value: 'normal' | 'large') => updateSetting('cursorSize', value)}
                            >
